...
STAGE2_EPOCHS   = 10
STAGE3_EPOCHS   = 10
OUTPUT_DIR      = "./outputs_experiment_combined_mobilenetv2_coarse"
SEED            = 42
...
model = make_mobilenetv2(len(coarse_classes))
crit  = nn.CrossEntropyLoss()

# Stage 1: head-only (freeze backbone, train classifier)
...
# Stage 2: unfreeze last 3 inverted residual blocks
...
print("✅ Coarse-only MobileNetV2 experiment complete. Outputs in", OUTPUT_DIR)
